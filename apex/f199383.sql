...
,p_release=>'26.1.0'
,p_default_workspace_id=>160531400190217018227
,p_default_application_id=>199383
,p_default_id_offset=>0
,p_default_owner=>'WKSP_T2626'
);
end;
/
 
prompt APPLICATION 199383 - Dann Alpes Reviews
--
-- Application Export:
--   Application:     199383
--   Name:            Dann Alpes Reviews
--   Date and Time:   03:32 Wednesday May 27, 2026
--   Exported By:     NATALIAGARCIARIN@GMAIL.COM
--   Flashback:       0
...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'WKSP_T2626')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Dann Alpes Reviews')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'DANN-ALPES-REVIEWS')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'D7E153548A34B0C0C657FA03BBBC47D6A988CEEE0272E4EEFACBD45F347785E5'
...
,p_authentication_id=>wwv_flow_imp.id(4041658473874845415)
,p_application_tab_set=>0
,p_logo_type=>'T'
,p_logo_text=>'Dann Alpes Reviews'
...
,p_substitution_value_01=>'Dann Alpes Reviews'
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260527025936Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_last_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_file_prefix=>nvl(wwv_flow_application_install.get_static_app_file_prefix,'')
,p_files_version=>2461188004825
,p_version_scn=>'15772671723753'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_imp.id(4041659315140845417)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2469215554099805162
,p_nav_list_template_options=>'#DEFAULT#:t-TreeNav--styleA:js-navCollapsed--hidden'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(4041660154083845424)
,p_nav_bar_list_template_id=>2849019392706229583
,p_nav_bar_template_options=>'#DEFAULT#'
);
end;
/
prompt --workspace/remote_servers/dann_alpes_api_df4w_onrender_com
begin
wwv_imp_workspace.create_remote_server(
 p_id=>4051528258833040708
,p_name=>'dann-alpes-api-df4w-onrender-com'
,p_static_id=>'dann-alpes-api-df4w-onrender-com'
,p_base_url=>nvl(wwv_flow_application_install.get_remote_server_base_url('dann-alpes-api-df4w-onrender-com'),'https://dann-alpes-api-df4w.onrender.com/')
,p_https_host=>nvl(wwv_flow_application_install.get_remote_server_https_host('dann-alpes-api-df4w-onrender-com'),'')
,p_server_type=>'WEB_SERVICE'
,p_ords_timezone=>nvl(wwv_flow_application_install.get_remote_server_ords_tz('dann-alpes-api-df4w-onrender-com'),'')
,p_prompt_on_install=>false
,p_created_on=>wwv_flow_imp.dz('20260527012058Z')
,p_updated_on=>wwv_flow_imp.dz('20260527012058Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
end;
/
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041654027595845405)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>'SH256:NcagEyRP_F17oe14bnrSYSYienkBgpdRSvH17g_NxoE'
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004825Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041654333657845406)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041654637351845406)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041654902884845407)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041655205692845408)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041655504940845408)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041655855648845409)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041656119963845409)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041656405057845410)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041656776876845410)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041657062886845412)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041657337033845412)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041657686487845413)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(4041657928535845413)
,p_plugin_type=>'WEB SOURCE TYPE'
...
/
prompt --application/shared_components/web_sources/rfc1_top_hoteles
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(4051530541310040726)
,p_name=>'RFC1_TOP_HOTELES'
,p_static_id=>'rfc1-top-hoteles'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(4051528814719040715)
,p_remote_server_id=>4051528258833040708
,p_url_path_prefix=>'/rfc1/top-hoteles'
,p_version_scn=>'SH256:XebvvGO2L0kgur_WWKLpB4AMajIIvJvyYcM0DC73ghk'
,p_created_on=>wwv_flow_imp.dz('20260527012058Z')
,p_updated_on=>wwv_flow_imp.dz('20260527012058Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(4051528814719040715)
,p_name=>'RFC1_TOP_HOTELES'
,p_format=>'JSON'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4051529383441040721)
,p_data_profile_id=>wwv_flow_imp.id(4051528814719040715)
,p_name=>'C_ID'
,p_static_id=>'c-id'
,p_sequence=>1
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4051530089335040722)
,p_data_profile_id=>wwv_flow_imp.id(4051528814719040715)
,p_name=>'PROMEDIO_CALIFICACION'
,p_static_id=>'promedio-calificacion'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
,p_selector=>'promedio_calificacion'
,p_remote_data_type=>'number'
,p_created_on=>wwv_flow_imp.dz('20260527012058Z')
,p_updated_on=>wwv_flow_imp.dz('20260527012058Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4051529730247040722)
,p_data_profile_id=>wwv_flow_imp.id(4051528814719040715)
,p_name=>'TOTAL_RESENAS'
,p_static_id=>'total-resenas'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
,p_selector=>'total_resenas'
,p_remote_data_type=>'number'
,p_created_on=>wwv_flow_imp.dz('20260527012058Z')
,p_updated_on=>wwv_flow_imp.dz('20260527012058Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(4051530893214040728)
,p_web_src_module_id=>wwv_flow_imp.id(4051530541310040726)
,p_static_id=>'get'
,p_operation=>'GET'
...
/
prompt --application/shared_components/web_sources/rfc2_evolucion
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(4054862856015752727)
,p_name=>'RFC2_EVOLUCION'
,p_static_id=>'rfc2-evolucion'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(4054861737930752714)
,p_remote_server_id=>4051528258833040708
,p_url_path_prefix=>'rfc2/evolucion/1'
,p_version_scn=>'SH256:sCERLqmkSwYrgG261IXkJoOch-6PUqibFwKH7K--fCY'
,p_created_on=>wwv_flow_imp.dz('20260527013046Z')
,p_updated_on=>wwv_flow_imp.dz('20260527013046Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(4054861737930752714)
,p_name=>'RFC2_EVOLUCION'
,p_format=>'JSON'
,p_use_raw_json_selectors=>false
,p_is_single_row=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4054861948517752723)
,p_data_profile_id=>wwv_flow_imp.id(4054861737930752714)
,p_name=>'C_ID_MES'
,p_static_id=>'c-id-mes'
,p_sequence=>1
,p_column_type=>'DATA'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4054862223950752725)
,p_data_profile_id=>wwv_flow_imp.id(4054861737930752714)
,p_name=>'CANTIDAD_RESENAS'
,p_static_id=>'cantidad-resenas'
,p_sequence=>2
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
,p_selector=>'cantidad_resenas'
,p_remote_data_type=>'number'
,p_created_on=>wwv_flow_imp.dz('20260527013046Z')
,p_updated_on=>wwv_flow_imp.dz('20260527013046Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4054862507593752725)
,p_data_profile_id=>wwv_flow_imp.id(4054861737930752714)
,p_name=>'PROMEDIO_CALIFICACION'
,p_static_id=>'promedio-calificacion'
,p_sequence=>3
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(4054863025505752732)
,p_web_src_module_id=>wwv_flow_imp.id(4054862856015752727)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
/
prompt --application/shared_components/web_sources/rfc3_perfil_ciudad
begin
wwv_flow_imp_shared.create_web_source_module(
 p_id=>wwv_flow_imp.id(4056617220165911241)
,p_name=>'RFC3_PERFIL_CIUDAD'
,p_static_id=>'rfc3-perfil-ciudad'
,p_web_source_type=>'NATIVE_HTTP'
,p_data_profile_id=>wwv_flow_imp.id(4056615471365911234)
,p_remote_server_id=>4051528258833040708
,p_url_path_prefix=>'rfc3/perfil-ciudad/Bogota'
,p_version_scn=>'SH256:69iMj4Z--QS_4uuhbR0IfuphL_rFQJOTyO2hM0ZZTZo'
,p_created_on=>wwv_flow_imp.dz('20260527015711Z')
,p_updated_on=>wwv_flow_imp.dz('20260527015711Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(4056615471365911234)
,p_name=>'RFC3_PERFIL_CIUDAD'
,p_format=>'JSON'
,p_use_raw_json_selectors=>false
,p_is_single_row=>false
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4056615777669911240)
,p_data_profile_id=>wwv_flow_imp.id(4056615471365911234)
,p_name=>'HOTEL_ID'
,p_static_id=>'hotel-id'
,p_sequence=>1
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
,p_selector=>'hotel_id'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4056616352585911240)
,p_data_profile_id=>wwv_flow_imp.id(4056615471365911234)
,p_name=>'PORCENTAJE_DESTACADAS'
,p_static_id=>'porcentaje-destacadas'
,p_sequence=>3
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
,p_selector=>'porcentaje_destacadas'
,p_remote_data_type=>'number'
,p_created_on=>wwv_flow_imp.dz('20260527015711Z')
,p_updated_on=>wwv_flow_imp.dz('20260527015711Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4056616982346911241)
,p_data_profile_id=>wwv_flow_imp.id(4056615471365911234)
,p_name=>'PORCENTAJE_RESPUESTA_ADMIN'
,p_static_id=>'porcentaje-respuesta-admin'
,p_sequence=>5
,p_column_type=>'DATA'
,p_data_type=>'NUMBER'
,p_selector=>'porcentaje_respuesta_admin'
,p_remote_data_type=>'number'
,p_created_on=>wwv_flow_imp.dz('20260527015711Z')
,p_updated_on=>wwv_flow_imp.dz('20260527015711Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4056616694936911240)
,p_data_profile_id=>wwv_flow_imp.id(4056615471365911234)
,p_name=>'PROMEDIO_CALIFICACION'
,p_static_id=>'promedio-calificacion'
,p_sequence=>4
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(4056616047222911240)
,p_data_profile_id=>wwv_flow_imp.id(4056615471365911234)
,p_name=>'TOTAL_RESENAS'
,p_static_id=>'total-resenas'
,p_sequence=>2
...
wwv_flow_imp_shared.create_web_source_operation(
 p_id=>wwv_flow_imp.id(4056617458924911247)
,p_web_src_module_id=>wwv_flow_imp.id(4056617220165911241)
,p_static_id=>'get'
,p_operation=>'GET'
,p_database_operation=>'FETCH_COLLECTION'
,p_url_pattern=>'.'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(4041660154083845424)
,p_name=>'Navigation Bar'
,p_static_id=>'navigation-bar'
,p_version_scn=>'SH256:vnb1-G39r80BPE-5P2Enpuf0sMSVvBeNQDVbFiNwRto'
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004826Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4041673245733845449)
...
,p_created_on=>wwv_flow_imp.dz('20260527004826Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004826Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4041673801853845450)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'---'
,p_static_id=>'list_item'
,p_list_item_link_target=>'separator'
,p_list_item_disp_cond_type=>'USER_IS_NOT_PUBLIC_USER'
,p_parent_list_item_id=>wwv_flow_imp.id(4041673245733845449)
,p_list_item_current_type=>'TARGET_PAGE'
,p_created_on=>wwv_flow_imp.dz('20260527004826Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004826Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4041674340950845451)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(4041659315140845417)
,p_name=>'Navigation Menu'
,p_static_id=>'navigation-menu'
,p_version_scn=>'SH256:_HLPiJaIiBe_jj8RxO3kWDqpnRH_SopJ3uQEwmbSvyU'
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_updated_on=>wwv_flow_imp.dz('20260527020602Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4058727213958311128)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>unistr('Gesti\00F3n de Rese\00F1as RF1-RF9')
,p_static_id=>unistr('gesti\00F3n-de-rese\00F1as-rf1-rf9')
,p_list_item_link_target=>'f?p=&APP_ID.:10:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-file-o'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'10'
,p_created_on=>wwv_flow_imp.dz('20260527020602Z')
,p_updated_on=>wwv_flow_imp.dz('20260527020602Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4041670724392845442)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4051768130162052110)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'RFC1 Top Hoteles'
,p_static_id=>'rfc1-top-hoteles'
,p_list_item_link_target=>'f?p=&APP_ID.:4:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-table'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'4'
,p_created_on=>wwv_flow_imp.dz('20260527012252Z')
,p_updated_on=>wwv_flow_imp.dz('20260527012252Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4054894672011760264)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'RFC2 Evolucion'
,p_static_id=>'rfc2-evolucion'
,p_list_item_link_target=>'f?p=&APP_ID.:6:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-table'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'6'
,p_created_on=>wwv_flow_imp.dz('20260527013201Z')
,p_updated_on=>wwv_flow_imp.dz('20260527013201Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(4058299522498272075)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'RFC3 Perfil Ciudad'
,p_static_id=>'rfc3-perfil-ciudad'
,p_list_item_link_target=>'f?p=&APP_ID.:8:&APP_SESSION.::&DEBUG.:::'
,p_list_item_icon=>'fa-table'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'8'
,p_created_on=>wwv_flow_imp.dz('20260527015932Z')
,p_updated_on=>wwv_flow_imp.dz('20260527015932Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
end;
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(4041661540556845428)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(4041661831974845429)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(4041662106575845430)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(4041661248492845428)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(4041662431995845431)
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(4041663758157845431)
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(4041672187765845446)
,p_lov_name=>'BOOLEAN'
,p_static_id=>'boolean'
,p_lov_query=>'.'||wwv_flow_imp.id(4041672187765845446)||'.'
,p_location=>'STATIC'
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4041672815174845448)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(4041672404147845447)
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(4041664025936845433)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(4041658864615845416)
,p_name=>'Breadcrumb'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4058728220984311132)
,p_short_name=>unistr('Gesti\00F3n de Rese\00F1as RF1-RF9')
,p_static_id=>unistr('gesti\00F3n-de-rese\00F1as-rf1-rf9')
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4041659021930845416)
,p_short_name=>'Home'
,p_static_id=>'home'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4051769131452052115)
,p_short_name=>'RFC1 Top Hoteles'
,p_static_id=>'rfc1-top-hoteles'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4054895686148760268)
,p_short_name=>'RFC2 Evolucion'
,p_static_id=>'rfc2-evolucion'
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(4058300531569272079)
,p_short_name=>'RFC3 Perfil Ciudad'
,p_static_id=>'rfc3-perfil-ciudad'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(4041659795709845418)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_build_option(
 p_id=>wwv_flow_imp.id(4041658109163845414)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(4041658473874845415)
...
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260527004825Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_last_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
end;
...
,p_name=>'Home'
,p_alias=>'HOME'
,p_step_title=>'Dann Alpes Reviews'
,p_autocomplete_on_off=>'OFF'
...
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260527004826Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_last_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4041671683933845445)
,p_plug_name=>'Dann Alpes Reviews'
,p_static_id=>'dann-alpes-reviews'
...
wwv_flow_imp_page.create_page(
 p_id=>4
,p_name=>'RFC1 Top Hoteles'
,p_alias=>'RFC1-TOP-HOTELES'
,p_step_title=>'RFC1 Top Hoteles'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4073832297226169690
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
...
,p_created_on=>wwv_flow_imp.dz('20260527012252Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260527012255Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_last_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4051768564373052113)
...
,p_plug_display_point=>'REGION_POSITION_01'
,p_plug_item_display_point=>'ABOVE'
,p_menu_id=>wwv_flow_imp.id(4041658864615845416)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(4051771008058052414)
,p_name=>'RFC1 Top Hoteles'
,p_static_id=>'rfc1-top-hoteles'
...
,p_created_on=>wwv_flow_imp.dz('20260527012255Z')
,p_updated_on=>wwv_flow_imp.dz('20260527012255Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4051771620403052417)
,p_query_column_id=>1
,p_column_alias=>'C_ID'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4051772426008052419)
,p_query_column_id=>3
,p_column_alias=>'PROMEDIO_CALIFICACION'
,p_column_display_sequence=>3
,p_column_heading=>'Promedio Calificacion'
,p_column_alignment=>'RIGHT'
,p_heading_alignment=>'RIGHT'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4051772094086052418)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page(
 p_id=>6
,p_name=>'RFC2 Evolucion'
,p_alias=>'RFC2-EVOLUCION'
,p_step_title=>'RFC2 Evolucion'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4073832297226169690
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'03'
,p_created_on=>wwv_flow_imp.dz('20260527013201Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260527013204Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_last_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4054895046530760266)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(4054896624608760542)
,p_name=>'RFC2 Evolucion'
,p_static_id=>'rfc2-evolucion'
,p_template=>4073835273271169698
,p_display_sequence=>10
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260527013204Z')
,p_updated_on=>wwv_flow_imp.dz('20260527013204Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4054897670014760545)
,p_query_column_id=>2
,p_column_alias=>'CANTIDAD_RESENAS'
,p_column_display_sequence=>2
,p_column_heading=>'Cantidad Resenas'
,p_column_alignment=>'RIGHT'
,p_heading_alignment=>'RIGHT'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4054897253572760544)
,p_query_column_id=>1
,p_column_alias=>'C_ID_MES'
,p_column_display_sequence=>1
,p_column_heading=>'C Id Mes'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4054898011949760546)
,p_query_column_id=>3
,p_column_alias=>'PROMEDIO_CALIFICACION'
,p_column_display_sequence=>3
,p_column_heading=>'Promedio Calificacion'
...
wwv_flow_imp_page.create_page(
 p_id=>8
,p_name=>'RFC3 Perfil Ciudad'
,p_alias=>'RFC3-PERFIL-CIUDAD'
,p_step_title=>'RFC3 Perfil Ciudad'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>4073832297226169690
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_page_component_map=>'03'
,p_created_on=>wwv_flow_imp.dz('20260527015932Z')
,p_last_updated_on=>wwv_flow_imp.dz('20260527015935Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_last_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4058299928895272078)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(4058302087751272394)
,p_name=>'RFC3 Perfil Ciudad'
,p_static_id=>'rfc3-perfil-ciudad'
,p_template=>4073835273271169698
,p_display_sequence=>10
...
,p_sort_null=>'L'
,p_plug_query_strip_html=>'N'
,p_created_on=>wwv_flow_imp.dz('20260527015935Z')
,p_updated_on=>wwv_flow_imp.dz('20260527015935Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4058302690343272398)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4058303498652272399)
,p_query_column_id=>3
,p_column_alias=>'PORCENTAJE_DESTACADAS'
,p_column_display_sequence=>3
,p_column_heading=>'Porcentaje Destacadas'
,p_column_alignment=>'RIGHT'
,p_heading_alignment=>'RIGHT'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4058304204317272401)
,p_query_column_id=>5
,p_column_alias=>'PORCENTAJE_RESPUESTA_ADMIN'
,p_column_display_sequence=>5
,p_column_heading=>'Porcentaje Respuesta Admin'
,p_column_alignment=>'RIGHT'
,p_heading_alignment=>'RIGHT'
,p_disable_sort_column=>'N'
,p_derived_column=>'N'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4058303869386272400)
,p_query_column_id=>4
,p_column_alias=>'PROMEDIO_CALIFICACION'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(4058303091858272399)
,p_query_column_id=>2
,p_column_alias=>'TOTAL_RESENAS'
,p_column_display_sequence=>2
,p_column_heading=>'Total Resenas'
...
wwv_flow_imp_page.create_page(
 p_id=>10
,p_name=>unistr('Gesti\00F3n de Rese\00F1as RF1-RF9')
,p_alias=>unistr('GESTI\00D3N-DE-RESE\00D1AS-RF1-RF9')
,p_step_title=>unistr('Gesti\00F3n de Rese\00F1as RF1-RF9')
,p_autocomplete_on_off=>'OFF'
,p_javascript_code=>wwv_flow_string.join(wwv_flow_t_varchar2(
'const API_BASE = ''https://dann-alpes-api-df4w.onrender.com'';',
'',
'function mostrarResultado(data) {',
'  document.getElementById(''resultado-rf'').innerHTML =',
...
'  fetch(`${API_BASE}/hoteles/${apex.item(''P10_HOTEL_ID'').getValue()}/resenas`, {',
'    method: ''POST'',',
'    headers: {''Content-Type'': ''application/json''},',
'    body: JSON.stringify({',
'      cliente_id: parseInt(apex.item(''P10_CLIENTE_ID'').getValue()),',
'      reserva_id: parseInt(apex.item(''P10_RESERVA_ID'').getValue()),',
'      calificacion: parseInt(apex.item(''P10_CALIFICACION'').getValue()),',
'      texto: apex.item(''P10_TEXTO'').getValue(),',
...
'  fetch(`${API_BASE}/resenas/${apex.item(''P10_RESENA_ID'').getValue()}`, {',
'    method: ''PUT'',',
'    headers: {''Content-Type'': ''application/json''},',
'    body: JSON.stringify({',
'      calificacion: parseInt(apex.item(''P10_CALIFICACION'').getValue()),',
...
'',
'function marcarUtil() {',
'  fetch(`${API_BASE}/resenas/${apex.item(''P10_RESENA_ID'').getValue()}/util`, {',
'    method: ''POST''',
'  }).then(r => r.json()).then(mostrarResultado);',
'}',
'',
'function historialCliente() {',
'  fetch(`${API_BASE}/clientes/${apex.item(''P10_CLIENTE_ID'').getValue()}/resenas`)',
'    .then(r => r.json())',
'    .then(mostrarResultado);',
'}',
'',
'function responderResena() {',
'  fetch(`${API_BASE}/resenas/${apex.item(''P10_RESENA_ID'').getValue()}/respuesta`, {',
'    method: ''POST'',',
'    headers: {''Content-Type'': ''application/json''},',
'    body: JSON.stringify({',
'      admin_id: parseInt(apex.item(''P10_ADMIN_ID'').getValue()),',
'      texto: apex.item(''P10_RESPUESTA'').getValue()',
'    })',
'  }).then(r => r.json()).then(mostrarResultado);',
'}',
'',
'function eliminarAdmin() {',
'  fetch(`${API_BASE}/admin/resenas/${apex.item(''P10_RESENA_ID'').getValue()}`, {',
'    method: ''DELETE''',
'  }).then(r => r.json()).then(mostrarResultado);',
'}',
'',
'function destacarResena() {',
'  fetch(`${API_BASE}/resenas/${apex.item(''P10_RESENA_ID'').getValue()}/destacar`, {',
'    method: ''POST''',
'  }).then(r => r.json()).then(mostrarResultado);',
'}'))
,p_step_template=>4073832297226169690
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4058727640462311131)
,p_plug_name=>'Breadcrumb'
,p_static_id=>'breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(869270286411518624)
,p_plug_name=>'Formulario RF1-RF9'
,p_static_id=>'formulario-rf1-rf9'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021018Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021018Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(869272123035518643)
,p_plug_name=>'Resultado API'
,p_static_id=>'resultado-api'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>4073835273271169698
,p_plug_display_sequence=>20
,p_plug_item_display_point=>'ABOVE'
,p_location=>null
,p_plug_source=>'<div id="resultado-rf"></div>'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527022252Z')
,p_updated_on=>wwv_flow_imp.dz('20260527022252Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271526563518637)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_button_name=>'BTN_CONSULTAR_HOTEL'
,p_static_id=>'btn-consultar-hotel'
,p_show_as_disabled=>false
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4073839297780169708
,p_button_image_alt=>'Consultar Hotel'
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527021901Z')
,p_updated_on=>wwv_flow_imp.dz('20260527023757Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271231815518634)
...
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527021727Z')
,p_updated_on=>wwv_flow_imp.dz('20260527023526Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869272048248518642)
...
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527022204Z')
,p_updated_on=>wwv_flow_imp.dz('20260527024700Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271390542518635)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4073839297780169708
,p_button_image_alt=>unistr(' Editar Rese\00F1a')
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527021805Z')
,p_updated_on=>wwv_flow_imp.dz('20260527023622Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271940421518641)
,p_button_sequence=>160
,p_button_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_button_name=>'BTN_ELIMINAR_ADMIN'
,p_static_id=>'btn-eliminar-admin'
,p_show_as_disabled=>false
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4073839297780169708
,p_button_image_alt=>'Eliminar Admin'
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527022124Z')
,p_updated_on=>wwv_flow_imp.dz('20260527023707Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271480430518636)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_button_name=>'BTN_ELIMINAR_RESENA'
,p_static_id=>'btn-eliminar-resena'
,p_show_as_disabled=>false
...
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527021836Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021836Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271775786518639)
,p_button_sequence=>140
,p_button_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_button_name=>'BTN_HISTORIAL'
,p_static_id=>'btn-historial'
,p_show_as_disabled=>false
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4073839297780169708
...
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527021956Z')
,p_updated_on=>wwv_flow_imp.dz('20260527024200Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271682463518638)
,p_button_sequence=>130
,p_button_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_button_name=>'BTN_MARCAR_UTIL'
,p_static_id=>'btn-marcar-util'
,p_show_as_disabled=>false
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4073839297780169708
...
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527021926Z')
,p_updated_on=>wwv_flow_imp.dz('20260527023844Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(869271840794518640)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4073839297780169708
,p_button_image_alt=>unistr('Responder Rese\00F1a')
,p_warn_on_unsaved_changes=>null
,p_grid_new_row=>'Y'
,p_created_on=>wwv_flow_imp.dz('20260527022047Z')
,p_updated_on=>wwv_flow_imp.dz('20260527024247Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869270802849518630)
,p_name=>'P1_ADMIN_ID'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_prompt=>'Admin Id'
...
,p_created_on=>wwv_flow_imp.dz('20260527021349Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021349Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869270623002518628)
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'subtype', 'TEXT',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021250Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021250Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869270462564518626)
,p_name=>'P1_CLIENTE_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_prompt=>'Cliente Id'
,p_source_type=>'ALWAYS_NULL'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'subtype', 'TEXT',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021158Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021158Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869270363905518625)
,p_name=>'P1_HOTEL_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_prompt=>'Hotel Id'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'subtype', 'TEXT',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021104Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021104Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869270764549518629)
,p_name=>'P1_RESENA_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_prompt=>'Resena Id'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'subtype', 'TEXT',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021326Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021326Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869270534619518627)
,p_name=>'P1_RESERVA_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_prompt=>'Reserva Id'
,p_source_type=>'ALWAYS_NULL'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'subtype', 'TEXT',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021224Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021224Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869271179391518633)
,p_name=>'P1_RESPUESTA'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_prompt=>'Respuesta'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'resizable', 'Y',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021514Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021514Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(869271027251518632)
,p_name=>'P1_TEXTO'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(869270286411518624)
,p_prompt=>'Texto'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'resizable', 'Y',
  'trim_spaces', 'BOTH')).to_clob
,p_created_on=>wwv_flow_imp.dz('20260527021449Z')
,p_updated_on=>wwv_flow_imp.dz('20260527021449Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4061974764484498001)
,p_name=>'DA_CONSULTAR'
,p_static_id=>'da-consultar'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271526563518637)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527023757Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025620Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4061974802173498002)
,p_event_id=>wwv_flow_imp.id(4061974764484498001)
,p_event_result=>'TRUE'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'fetch(''https://dann-alpes-api-df4w.onrender.com/hoteles/'' + ',
    'apex.item(''P1_HOTEL_ID'').getValue() + ''/resenas'')',
    '',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(869272257961518644)
,p_name=>'DA_CREAR_RESENA'
,p_static_id=>'da-crear-resena'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271231815518634)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527023526Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025133Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(869272441128518646)
,p_event_id=>wwv_flow_imp.id(869272257961518644)
,p_event_result=>'TRUE'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    ...
    '    body: JSON.stringify({',
    '',
    '        cliente_id: parseInt(apex.item(''P1_CLIENTE_ID'').getValue()),',
    '',
    '        reserva_id: parseInt(apex.item(''P1_RESERVA_ID'').getValue()),',
    '',
    '        calificacion: parseInt(apex.item(''P1_CALIFICACION'').getValue()),',
    '',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4061975780333498011)
,p_name=>'DA_DESTACAR'
,p_static_id=>'da-destacar'
,p_event_sequence=>90
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869272048248518642)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527024700Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025936Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4061975803694498012)
,p_event_id=>wwv_flow_imp.id(4061975780333498011)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'fetch(''https://dann-alpes-api-df4w.onrender.com/resenas/'' + ',
    'apex.item(''P1_RESENA_ID'').getValue() + ''/destacar'', {',
    '',
    '    method: ''POST''',
    '',
    '})',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(869272538316518647)
,p_name=>'DA_EDITAR'
,p_static_id=>'da-editar'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271390542518635)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527023622Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025417Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(869272612554518648)
,p_event_id=>wwv_flow_imp.id(869272538316518647)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'fetch(''https://dann-alpes-api-df4w.onrender.com/resenas/'' + ',
    'apex.item(''P1_RESENA_ID'').getValue(), {',
    '',
    '    method: ''PUT'',',
    '',
    '    headers: {',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(869272733315518649)
,p_name=>'DA_ELIMINAR'
,p_static_id=>'da-eliminar'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271940421518641)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527023707Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025538Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(869272848760518650)
,p_event_id=>wwv_flow_imp.id(869272733315518649)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4061975558466498009)
,p_name=>'DA_ELIMINAR_ADMIN'
,p_static_id=>'da-eliminar-admin'
,p_event_sequence=>80
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271940421518641)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527024529Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025902Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4061975638771498010)
,p_event_id=>wwv_flow_imp.id(4061975558466498009)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'fetch(''https://dann-alpes-api-df4w.onrender.com/admin/resenas/'' + ',
    'apex.item(''P1_RESENA_ID'').getValue(), {',
    '',
    '    method: ''DELETE''',
    '',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4061975162067498005)
,p_name=>'DA_HISTORIAL'
,p_static_id=>'da-historial'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271775786518639)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527024200Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025741Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4061975266757498006)
,p_event_id=>wwv_flow_imp.id(4061975162067498005)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'fetch(''https://dann-alpes-api-df4w.onrender.com/clientes/'' + ',
    'apex.item(''P1_CLIENTE_ID'').getValue() + ''/resenas'')',
    '',
    '.then(response => response.json())',
    '',
    '.then(data => {',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4061975350651498007)
,p_name=>'DA_RESPONDER'
,p_static_id=>'da-responder'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271840794518640)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527024247Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025828Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4061975481803498008)
,p_event_id=>wwv_flow_imp.id(4061975350651498007)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'fetch(''https://dann-alpes-api-df4w.onrender.com/resenas/'' + ',
    'apex.item(''P1_RESENA_ID'').getValue() + ''/respuesta'', {',
    '',
    '    method: ''POST'',',
    '',
    '    headers: {',
    ...
    '    body: JSON.stringify({',
    '',
    '        admin_id: parseInt(apex.item(''P1_ADMIN_ID'').getValue()),',
    '',
    '        texto: apex.item(''P1_RESPUESTA'').getValue()',
    '    })',
    '',
    '})',
    '.then(response => response.json())',
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(4061974992153498003)
,p_name=>'DA_UTIL'
,p_static_id=>'da-util'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(869271682463518638)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
,p_created_on=>wwv_flow_imp.dz('20260527023844Z')
,p_updated_on=>wwv_flow_imp.dz('20260527025658Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(4061975073882498004)
,p_event_id=>wwv_flow_imp.id(4061974992153498003)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_static_id=>'native-javascript-code'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'js_code', wwv_flow_string.join(wwv_flow_t_varchar2(
    'fetch(''https://dann-alpes-api-df4w.onrender.com/resenas/'' + ',
    'apex.item(''P1_RESENA_ID'').getValue() + ''/util'', {',
    '',
    '    method: ''POST''',
    '',
    '})',
...
,p_name=>'Login Page'
,p_alias=>'LOGIN'
,p_step_title=>'Dann Alpes Reviews - Log In'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4041664699634845435)
,p_plug_name=>'Dann Alpes Reviews'
,p_static_id=>'dann-alpes-reviews'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(4041666242449845437)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(4041664699634845435)
,p_button_name=>'LOGIN'
,p_static_id=>'login'
,p_show_as_disabled=>false
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4041665536680845437)
,p_name=>'P9999_PASSWORD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(4041664699634845435)
,p_prompt=>'Password'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4041665999912845437)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(4041665153260845436)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4041670325102845441)
...
,p_internal_uid=>4041670325102845441
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004825Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4041669962654845441)
...
,p_internal_uid=>4041669962654845441
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004825Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4041666669184845438)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>4041666669184845438
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004825Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(4041667635348845439)
,p_page_process_id=>wwv_flow_imp.id(4041666669184845438)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
,p_data_type=>'VARCHAR2'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(4041668126000845439)
,p_page_process_id=>wwv_flow_imp.id(4041666669184845438)
,p_page_id=>9999
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(4041667195834845439)
,p_page_process_id=>wwv_flow_imp.id(4041666669184845438)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(4041668557473845440)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_INVOKE_API'
...
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  ...
  'type', 'PLSQL_PACKAGE')).to_clob
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_internal_uid=>4041668557473845440
,p_created_on=>wwv_flow_imp.dz('20260527004825Z')
,p_updated_on=>wwv_flow_imp.dz('20260527004825Z')
,p_created_by=>'NATALIAGARCIARIN@GMAIL.COM'
,p_updated_by=>'NATALIAGARCIARIN@GMAIL.COM'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(4041669599856845441)
,p_page_process_id=>wwv_flow_imp.id(4041668557473845440)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
,p_data_type=>'BOOLEAN'
...
wwv_flow_imp_shared.create_invokeapi_comp_param(
 p_id=>wwv_flow_imp.id(4041669011682845440)
,p_page_process_id=>wwv_flow_imp.id(4041668557473845440)
,p_page_id=>9999
,p_name=>'p_username'
,p_direction=>'IN'
